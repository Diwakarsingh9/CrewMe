...
public class RangeBar extends View {
    ...
    private static final int DEFAULT_TICK_COLOR = Color.parseColor("#F55B47");

    // Corresponds to material indigo 500.
    private static final int DEFAULT_PIN_COLOR = Color.parseColor("#F55B47");

    private static final float DEFAULT_CONNECTING_LINE_WEIGHT_PX = 4;

    // Corresponds to material indigo 500.
    private static final int DEFAULT_CONNECTING_LINE_COLOR = Color.parseColor("#F55B47");

    private static final float DEFAULT_EXPANDED_PIN_RADIUS_DP = 20;

    private static final float DEFAULT_CIRCLE_SIZE_DP = 10;
    ...
    private int mConnectingLineColor = Color.parseColor("#00adef");
    ...
    private int mCircleColor = Color.parseColor("#bbbbbb");
