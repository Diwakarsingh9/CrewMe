package com.example.apporio6.crewme.flingswipe;
...
public class SwipeFlingAdapterView extends BaseFlingAdapterView {
    ...
    private static final int backgroundCardOffset = 0;
...
//        ROTATION_DEGREES = a.getFloat(R.styleable.SwipeFlingAdapterView_rotation_degrees, ROTATION_DEGREES);
    ...
    public void init(final Context context, Adapter mAdapter) {
        ...
        if (context instanceof AdapterView.OnItemClickListener) {
            mOnItemClickListener = (AdapterView.OnItemClickListener) context;
        }
        setAdapter(mAdapter);
    }
    ...
    private void makeAndAddView(View child) {
        ...
        if (needToMeasure) {
            int childWidthSpec = getChildMeasureSpec(getWidthMeasureSpec(),
                    getPaddingLeft() + getPaddingRight() + 5 + 5,
                   400);
            int childHeightSpec = getChildMeasureSpec(getHeightMeasureSpec(),
                    getPaddingTop() + getPaddingBottom() + 5 + 5,
                    400);
        ...
        switch (absoluteGravity & Gravity.HORIZONTAL_GRAVITY_MASK) {
            case Gravity.CENTER_HORIZONTAL:
                ...
                break;
            case Gravity.END:
                childLeft = getWidth() + getPaddingRight() - w - 5;
                break;
            case Gravity.START:
            default:
                childLeft = getPaddingLeft() + 5;
                break;
        }
        switch (verticalGravity) {
            case Gravity.CENTER_VERTICAL:
                ...
                break;
            case Gravity.BOTTOM:
                childTop = getHeight() - getPaddingBottom() - h - 5;
                break;
            case Gravity.TOP:
            default:
                childTop = getPaddingTop() +5;
                break;
        }
